...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <br /><br />
        <asp:gridview runat="server" ID="gvUrunler" AutoGenerateColumns="False" DataKeyNames="urunid" Width="506px" OnSelectedIndexChanged="gvUrunler_SelectedIndexChanged">
            <Columns>
